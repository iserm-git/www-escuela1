// app/gestion-curso/asistencia/page.tsx
"use client";
...
import type { Asistencia, EstadoAsistencia, AsistenciaFiltros } from "@/types/gestion-curso";
...
export default function AsistenciaPage() {
  ...
  const getEstadoChip = (estado: EstadoAsistencia) => {
    const configs = {
      presente: { icon: <PresenteIcon />, color: "success" as const, label: "Presente" },
      ausente: { icon: <AusenteIcon />, color: "error" as const, label: "Ausente" },
      retardo: { icon: <RetardoIcon />, color: "warning" as const, label: "Retardo" },
      justificado: { icon: <JustificadoIcon />, color: "info" as const, label: "Justificado" },
    };
        ...
        <Paper sx={{ p: 2, mb: 3 }}>
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <TextField
              ...
              onChange={(e) => setFiltros({ ...filtros, estado: e.target.value as EstadoAsistencia || undefined })}
              sx={{ minWidth: 150 }}
            >
